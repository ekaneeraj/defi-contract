...
import {MockMoreDebtDSC} from "../mock/MockMoreDebitDSC.sol";
...
contract DSCEngineTest is Test {
    ...
    function testRevertsIfCollateralZero() public {
        vm.startPrank(USER);
        IERC20(weth).approve(address(dsc), AMOUNT_COLLATERAL);
    ...
    function testRevertsWithUnapprovedCollateral() public {
        ...
        ERC20Mock(address(mockToken)).mint(USER, AMOUNT_COLLATERAL);

        vm.startPrank(USER);
        IERC20(address(mockToken)).approve(address(engine), AMOUNT_COLLATERAL);
    ...
    function testMustImproveHealthFactorOnLiquidation() public {
        // Arrange - Setup
        MockMoreDebtDSC mockDsc = new MockMoreDebtDSC(wethUsdPriceFeed, address(this));
        tokenAddresses = [weth];
        priceFeedAddresses = [wethUsdPriceFeed];
        address owner = msg.sender;
        vm.prank(owner);
